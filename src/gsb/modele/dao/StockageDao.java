...
public class StockageDao {
	public static Stockage rechercher(Medicament unMedicament, Visiteur unVisiteur, int qte){
		...
		try {
			...
			System.out.println("erreur reqSelection.next() pour la requ�te - select * from STOCKAGE where REFERENCE='"+qte+"'");
			e.printStackTrace();
			}
